...
export type KeyOf<T extends Rec, I extends string | number | symbol = any> = Extract<keyof T, I>;
...
export type HasNullOrUndefined<T1> = null extends T1 ? true : undefined extends T1 ? true : false;
