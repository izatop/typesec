...
export function when<T, R1>(value: T, then: Fn<[NonNullable<T>], R1>): R1 | void;
export function when<T, R1, R2>(value: T, then: Fn<[NonNullable<T>], R1>, fallback: Fnify<R2>): R1 | R2;
export function when<T, R1, R2>(value: T, then: Fn<[NonNullable<T>], R1>, fallback?: Fnify<R2>): R1 | R2 | void {
